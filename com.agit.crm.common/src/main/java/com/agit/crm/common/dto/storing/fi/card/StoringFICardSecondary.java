 ...
 * @author BayuHS
 */
public class StoringFICardSecondary {

    @ReadableColumn(column = "storingFICardID", index = 1)
    private String storingFICardID;
    @ReadableColumn(column = "pointCheck1", index = 2)
    private String pointCheck1;
    @ReadableColumn(column = "pointCheck2", index = 3)
    private String pointCheck2;
    @ReadableColumn(column = "pointCheck3", index = 4)
    private String pointCheck3;
    @ReadableColumn(column = "pointCheck4", index = 5)
    private String pointCheck4;
    @ReadableColumn(column = "pointCheck5", index = 6)
    private String pointCheck5;

    public StoringFICardSecondary() {
    }
